...
fwy <- st_read("data/utah_freeway", "utah_freeway", quiet = T) %>%
...
```{r coarse, eval = T, echo = F, fig.cap = "Map showing a raster with fine resolution (300 m X 300 m)", fig.align = 'center'}
dem <- raster("data/elevation.tif")
