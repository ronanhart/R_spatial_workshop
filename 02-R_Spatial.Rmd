...
* `resolution`: the size of the cells. In this case the cells are 30mX30m (Note that we know the units are **meters** because in the `crs` it tells us the units are m)
